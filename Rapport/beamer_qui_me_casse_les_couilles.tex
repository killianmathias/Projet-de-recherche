    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Caméra centrée sur joueur} : déplacement caméra, suivi Joueur
                \item \textbf{Mode spectateur} : contrôle caméra, vue libre, exploration rapide
                \item \textbf{Optimisation affichage} : calculs limités à la zone visible, blocs hors champ non affichés
            \end{itemize}
            % \begin{itemize}
